...
{
  "md", "steep", "cg", "bd", "sd", "nm", "l-bfgs", "tpi", "tpic", "sd1", "md-vv", "md-vv-avek", "two-s", "two-s-min-e", "two-s-verlet", "two-s-adapt", "two-s-adaptdt", "two-s-HOH", "three-s", "four-s", NULL 
};
...
const char *epcoupl_names[epcNR+1] = {
  "No", "Berendsen", "Parrinello-Rahman", "Isotropic", "MTTK", "Andersen", NULL
