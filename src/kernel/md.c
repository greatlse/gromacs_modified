                            ...
                            int natoms, gmx_bool *bSumEkinhOld, int flags)
{
    ...
    bEkinAveVel = (ir->eI==eiVV || ir->eI==eiTWOS || ir->eI==eiTWOSMIN || ir->eI==eiTWOSVERLET || ir->eI==eiTWOSADAPT || ir->eI==eiTHREES || ir->eI==eiFOURS || (ir->eI==eiVVAK && bPres) || bReadEkin);
