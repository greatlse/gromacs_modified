                            ...
                            int natoms, gmx_bool *bSumEkinhOld, int flags)
{
    ...
    bEkinAveVel = (ir->eI==eiVV || ir->eI==eiTWOS || ir->eI==eiTWOSMIN || ir->eI==eiTWOSADAPT || ir->eI==eiTHREES || ir->eI==eiFOURS || (ir->eI==eiVVAK && bPres) || bReadEkin);
             ...
             gmx_runtime_t *runtime)
{
    ...
    if (ir->eI != eiVV && ir->eI != eiTWOS && ir->eI != eiTWOSMIN && ir->eI != eiTWOSADAPT && ir->eI != eiTHREES && ir->eI != eiFOURS) 
    {
